#!/bin/bash
# Test push notification - run this after enabling push in the app
...
echo "📱 Check your browser console for service worker logs"
echo "🔔 Check if notification appeared on your device"
